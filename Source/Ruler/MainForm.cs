...
namespace Ruler
{
    ...
    sealed public class MainForm : Form, IRulerInfo
    {
        ...
        private System.Timers.Timer reoccuringTimer;
        ...
        public MainForm(RulerInfo rulerInfo)
        {
            ...
            this.reoccuringTimer = new System.Timers.Timer(500);
            this.reoccuringTimer.AutoReset = true;
            this.reoccuringTimer.Elapsed += ReoccuringTimer_Elapsed;
            this.reoccuringTimer.Enabled = true;
        ...
        private void Init(RulerInfo rulerInfo)
        {
           // Set fields
            ...
            this.Width = (int) (rulerInfo.Width*this.scaleFactor);
            this.Height =(int) (rulerInfo.Height*this.scaleFactor);
        ...
        private void ReoccuringTimer_Elapsed(object sender, ElapsedEventArgs e)
        {
            //float scale = (float)(100*Screen.PrimaryScreen.Bounds.Width / SystemParameters.PrimaryScreenWidth);
        ...
        protected override void WndProc(ref Message m)
        {
                ...
                if (m.Msg == WM_DPICHANGED)
            {
                ...
                float newDpi = (float)(m.WParam.ToInt64() & 0xFFFF);

                Debug.WriteLine(newDpi);
                    Debug.WriteLine(newDpi / 96);
                    this.ScaleFactor =(float) (newDpi / 96.0);
            }
        ...
        private void CopyRulerInfo(object sender, EventArgs e)
        {
            ...
            System.Windows.Forms.MessageBox.Show(string.Concat("Copied to clipboard:", Environment.NewLine, parameters));
        }
        ...
        private void AboutHandler(object sender, EventArgs e)
        {
          ...
          System.Windows.Forms.MessageBox.Show(message, "About Ruler", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        public void SaveHandler(object sender, EventArgs e)
        {
            ...
            foreach (MenuItem menuItem in saveMenuItem.Parent.MenuItems)
            {
                menuItem.Checked = false;
            }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            else
            {
                ...
                if (e.Button == MouseButtons.Left)
                {
                    ...
                    this.DisplayedLocation = this.Location;
                }
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (firstRun)
            {
               this.ScaleFactor =(float)(this.DeviceDpi/96.0);
            }
            ...
            if (this.IsVertical)
            {
                ...
                height =(int)(this.Width*this.scaleFactor);
                width =(int)(this.Height*this.scaleFactor);
            }
